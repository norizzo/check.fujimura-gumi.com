...
<body>
    ...
    <script>
        ...
        document.getElementById('genbaSelect').addEventListener('change', function() {
            ...
            console.log('data[normalizedSelectedGenba]:', data[normalizedSelectedGenba]); // added for debug
            if (data[normalizedSelectedGenba]) { // added condition to check if data[normalizedSelectedGenba] exists
